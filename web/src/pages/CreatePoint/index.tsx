...
const CreatePoint = () => {
  ...
  useEffect(() => {
    axios.get("https://www.universal-tutorial.com/api/getaccesstoken", {
      ...
      axios.get<IGetStatesResponse[]>("https://www.universal-tutorial.com/api/states/Angola", { headers: {
  ...
  useEffect(() => {
    ...
    axios.get("https://www.universal-tutorial.com/api/getaccesstoken", {
      ...
      axios.get<IGetCityResponse[]>(`https://www.universal-tutorial.com/api/cities/${selectedState}`, { headers: {
        "Authorization": `Bearer ${res.data.auth_token}`,
        "Accept": "application/json"
      }}).then(data => {
